    ...
    <section>
        <div id="disclaimers">
            <div id="disclaimer-network">
                <span>This system can only be accessed using your <a href="https://www.sc.edu/about/offices_and_divisions/university_technology_services/services/student/logins/networkusername.php">Network Username</a>.</span>
            </div>
        </div>
    </section>
