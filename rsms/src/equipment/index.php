...
<!-- models -->
<!--script src="./scripts/models/someModel.js"></script-->
...
<body>
    ...
    <!-- NAVIGATION -->
      <div class="banner {{bannerClass | splitAtPeriod}} equipment" ng-class="{'dashboard-banner':dashboardView, 'hide': noHead}">
        <h1>Lab Equipment <a style="float:right;margin: 11px 128px 0 0; color:black" href="<?php echo WEB_ROOT?>views/RSMSCenter.php#/safety-programs"><i class="icon-home" style="font-size:40px;"></i></a></h1>
      </div>
    <!-- VIEW NESTING -->
