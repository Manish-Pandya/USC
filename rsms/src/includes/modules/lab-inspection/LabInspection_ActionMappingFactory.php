...
class LabInspection_ActionMappingFactory extends ActionMappingFactory {
	...
	public function getConfig() {
        return array(
            ...
            "saveDeficiencySelection"=>new SecuredActionMapping("saveDeficiencySelection", $this::$ROLE_GROUPS["EHS"], 'LabInspectionSecurity::userCanEditInspectionItem'),
            "saveOtherDeficiencySelection"=>new SecuredActionMapping("saveOtherDeficiencySelection", $this::$ROLE_GROUPS["EHS"], 'LabInspectionSecurity::userCanEditInspectionItem'),
            "removeDeficiencySelection"=>new SecuredActionMapping("removeDeficiencySelection", $this::$ROLE_GROUPS["EHS"], 'LabInspectionSecurity::userCanRemoveDeficiencySelection'),
            ...
            "saveObservationRelation"=>new SecuredActionMapping("saveObservationRelation", $this::$ROLE_GROUPS["EHS"], 'LabInspectionSecurity::userCanEditInspectionItem'),
            "saveRecommendationRelation"=>new SecuredActionMapping("saveRecommendationRelation", $this::$ROLE_GROUPS["EHS"], 'LabInspectionSecurity::userCanEditInspectionItem'),
            "saveSupplementalObservation"=>new SecuredActionMapping("saveSupplementalObservation", $this::$ROLE_GROUPS["EHS"], 'LabInspectionSecurity::userCanEditInspectionItem'),
            "saveSupplementalRecommendation"=>new SecuredActionMapping("saveSupplementalRecommendation", $this::$ROLE_GROUPS["EHS"], 'LabInspectionSecurity::userCanEditInspectionItem'),
            "saveSupplementalDeficiency"=>new SecuredActionMapping("saveSupplementalDeficiency", $this::$ROLE_GROUPS["EHS"], 'LabInspectionSecurity::userCanEditInspectionItem'),
