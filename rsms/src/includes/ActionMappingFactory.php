...
class ActionMappingFactory {
    ...
    public function getConfig(){
        $mappings = array(
                ...
                "getAllAssignableUserDetails"=>new SecuredActionMapping("getAllAssignableUserDetails", $this::$ROLE_GROUPS["ADMIN"]),
                ...
                "getMyLabWidgets" => new SecuredActionMapping("getMyLabWidgets", $this::$ROLE_GROUPS["EHS_AND_LAB"], 'LabInspectionSecurity::userCanViewPILabWidgets'),
