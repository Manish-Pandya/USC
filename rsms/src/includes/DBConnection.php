...
class DBConnection {
    ...
    private static function configure(){
        ...
        $dbhost = ApplicationConfiguration::get(ApplicationBootstrapper::CONFIG_SERVER_DB_HOST);
        $dbname = ApplicationConfiguration::get(ApplicationBootstrapper::CONFIG_SERVER_DB_NAME);
        ...
        if( isset($dbhost) && isset($dbname) ){
            ...
            self::$DB_CN = ApplicationConfiguration::get(ApplicationBootstrapper::CONFIG_SERVER_DB_CONNECTION);
        }

        self::$DB_UN = ApplicationConfiguration::get(ApplicationBootstrapper::CONFIG_SERVER_DB_USERNAME);
        ...
        */
        $pw = @ApplicationConfiguration::get(ApplicationBootstrapper::CONFIG_SERVER_DB_PASSWORD);
        if( isset($pw) && $pw !== '' ) {
            self::$DB_PW = $pw;
        }
