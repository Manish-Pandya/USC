      ...
      'ngQuickDateDefaults', '$filter', '$sce', function (ngQuickDateDefaults, $filter, $sce) {
          return {
              ...
              link: function (scope, element, attrs, ngModelCtrl) {
                  ...
                  if (!scope.buttonClass) scope.buttonClass = "btn-info";
                  ...
                  refreshView = function () {
                      ...
                      scope.placeholder = !scope.isIcon ? scope.placeholder : '';
                  ...
                  scope.selectDate = function (date, closeCalendar) {
                      ...
                      if (typeof scope.dateFilter === 'function' && !scope.dateFilter(date) && date != null) {
                          return false;
                      }
