angular
    ...
    .controller('TestCtrl', function ($rootScope, $scope, $q, $stateParams) {
        ...
        var getProtocol = function (): Promise<any> {
            ...
            return $q.all([DataStoreManager.getAll("IBCProtocol", $scope.protocols, [ibc.IBCProtocol.RevisionMap])]).then((p) => {
            //return $q.all([DataStoreManager.getById("IBCProtocol", $stateParams.id, $scope.protocol, [ibc.IBCProtocol.RevisionMap])]).then((p) => {
                ...
                var newProtocol: any = new ibc.IBCProtocol();
                ...
                var newRevision: any = new ibc.IBCProtocolRevision();
