...
(function (ibc) {
    ...
    IBCProtocol.SectionMap = new CompositionMapping(CompositionMapping.ONE_TO_MANY, "IBCSection", "getPropertyByName&type={{DataStoreManager.classPropName}}&property=Sections&id={{UID}}", "IBCSections", "Hazard_id", "Hazard_id");
