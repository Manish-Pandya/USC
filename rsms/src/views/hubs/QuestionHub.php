    ...
    <ul class="nav pageMenu" style="min-height: 50px; background: #d00; color:white !important; padding: 2px 0 2px 0; width:100%">
        <li class="">
            ...
            <h2 style="padding: 11px 0 5px 85px;margin-left: -15px;">Question Hub
                <a style="float:right;margin: 6px 35px 0 9px;" href="<?php echo WEB_ROOT;?>"><i class="icon-home" style="font-size:40px;"></i></a>
    ...
    <span ng-if="checklist">
        ...
        <form ng-if="question.beingEdited || noQuestion" class="form" style="margin-top:10px;">
            ...
            <div class="control-group">
             ...
             <a style="margin:-10px 0 0 0;" ng-click="saveEditedQuestion( question )" class="btn btn-success left"><i class="icon-checkmark"></i>Save Question</a>
            <a ng-show="question" style="margin:-10px 0 0 3px;" class="btn btn-danger left" ng-click="cancelEdit( question )"><i class="icon-cancel"></i>Cancel</a>
