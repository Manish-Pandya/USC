...
?>
                        ...
                        <form class="form">
                            <div class="control-group span4">
                                <label class="control-label" for="name">
                                    <h3>Principal Investigator</h3></label>
                                <div class="controls">
                                    <span ng-if="!PIs">
                        ...
                        <span ng-if="hazard.Name == 'Biological Safety'">Biological Hazards</span><span ng-if="hazard.Name == 'Chemical/Physical Safety' || hazard.Name == 'Chemical and Physical Safety'">Chemical/Physical Hazards</span><span ng-if="hazard.Name == 'Radiation Safety'">Radiation Hazards</span>
                                ...
                                <li ng-repeat="(key, child) in hazard.ActiveSubHazards | filter: {Is_equipment: false} | everyThirdChecked" class="hazardLi topChild" id="id-{{hazard.Key_Id}}" ng-if="child.IsPresent || !hazard.hideUnselected">
                                    ...
                                    <ul>
                                        <li ng-repeat="child in child.ActiveSubHazards" ng-if="child.IsPresent" class="hazardLi" id="id-{{child.Key_Id}}">
                                            <span ng-init="child.loadSubHazards()" data-ng-include="'sub-hazard-refactor.html'"></span>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                            ...
                            <ul class="topChildren">
                                <li ng-repeat="(key, child) in hazard.ActiveSubHazards | filter: {Is_equipment: true} | everyThirdChecked" class="hazardLi topChild" id="id-{{hazard.Key_Id}}" ng-if="child.IsPresent || !hazard.hideUnselected">
                                    ...
                                    <ul>
                                        <li ng-repeat="child in child.ActiveSubHazards" ng-if="child.IsPresent" class="hazardLi" id="id-{{child.Key_Id}}">
                                            <span data-ng-include="'sub-hazard-refactor.html'"></span>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
    ...
    <div id="footer" style="position:fixed; bottom:0; width:100%; background:white; left:0; z-index:1040; box-shadow:0 0 20px rgba(0,0,0,.5)" ng-if="PI">
        <ul class="container-fluid whitebg" style="padding:0 70px !Important">
            <li>
                <a ng-click="getArchivedReports(pi)"><img src="../../img/clipboard.png" /><span>Archived Reports</span></a>
            </li>
            <li>
                <a href="../hubs/PIHub.php#/personnel?pi={{PI.Key_id}}&inspection=true" target="_blank"><img src="../../img/phone.png" /><span>Laboratory Personnel</span></a>
            </li>
            <li>
                <a ng-click="openNotes()"><img src="../../img/speechBubble.png" /><span>Inspection Comments</span></a>
            </li>
            <li>
                <a ng-click="startInspection()"><img src="../../img/checkmarkFooter.png" /><span>Inspect Labs</a></span></li>
        </ul>
    </div>
    <!--</span>-->
    </div>
