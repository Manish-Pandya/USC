...
$KNOWN_ACTIONS = array(
    ...
    new DeleteAction( 10451, "JL Request Delete", "Carcinogen, mutagen, reproductive toxin, target organ toxin, aspiration toxin, respiratory sensitizer" ),
    ...
    new AddAction( 10423, "Oil bath" , "Unattended Operations posing flood or fire risk"),
    new AddAction( 10423, "Distillation" , "Unattended Operations posing flood or fire risk"),
    new AddAction( 10423, "Digestion" , "Unattended Operations posing flood or fire risk"),
    ...
    new DeleteAction( 10945, "JS Request Delete", "High Temperature oven" ),
    new DeleteAction( 10853, "JS Request Delete", "High Temperature Furnace" ),
    new MoveAction( 10885, "Equipment with mechanical hazards" ),
    new MoveAction( 10886, "Equipment with mechanical hazards" ),
    new DeleteAction( 10946, "JS Request Delete", "Temperature Chiller" ),
