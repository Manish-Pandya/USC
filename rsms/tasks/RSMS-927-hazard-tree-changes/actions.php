...
$KNOWN_ACTIONS = array(
    ...
    new InactivateAction( 10451, "Inactivate and split into several new hazards" ),
    ...
    new MoveAction( 10945, "Unattended operations posing flood or fire risk" ),
    new MoveAction( 10853, "Unattended operations posing flood or fire risk" ),
    new MoveAction( 10885, "Equipment with mechanical hazards" ),
    new MoveAction( 10886, "Equipment with mechanical hazards" ),
    new MoveAction( 10946, "Unattended operations posing floor or fire risk" ),
